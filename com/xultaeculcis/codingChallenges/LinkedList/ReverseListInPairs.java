...
public class ReverseListInPairs{
	...
	public static Node reverseLinkedListInPairsRec(Node head) {
		...
		head.next=reverseLinkedListInPairsRec(head.next);
		// returning new head
		return temp;
	}
	...
	public static void main(String[] args) {
		...
		Node result2=reverseLinkedListInPairsRec(result);
		System.out.println("After reversing in pair with recursion");
